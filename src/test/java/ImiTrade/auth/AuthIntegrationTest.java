...
class AuthIntegrationTest {
    ...
    void registerDuplicateEmail() throws Exception {
        ...
        RegisterRequest dup = new RegisterRequest("alice@example.com", "alice2", "S3cret!pass");
    ...
    void registerDuplicateUsername() throws Exception {
        register(new RegisterRequest("alice@example.com", "alice", "S3cret!pass"));

        RegisterRequest dup = new RegisterRequest("alice2@example.com", "alice", "S3cret!pass");
        mockMvc.perform(post("/api/v1/auth/register")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(dup)))
                .andExpect(status().isConflict())
    ...
    void registerPasswordIsHashed() throws Exception {
        ...
        register(new RegisterRequest("alice@example.com", "alice", raw));
    ...
    void registerValidationFails() throws Exception {
        ...
        RegisterRequest req = new RegisterRequest("not-an-email", "a_", "short");
