...
| `stock-details` | ✓ `/stocks/:ticker` — Header (логотип + сектор), Price Block, User Position (с «N lots»), Trading (reuse диалогов), About (описание), Company Information (Ticker, Name, Exchange, Lot Size, Sector, Website) |
